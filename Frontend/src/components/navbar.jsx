            ...
            <div className='ms-auto'>
              <div className="collapse navbar-collapse " id="navbarNav">
                <ul className="navbar-nav">
                  ...
                  <li className="nav-item">
                    <Link to='/user/getalluser' className="nav-link active" style={{color:"whitesmoke",marginRight:"10px"}} aria-current="page"><i style={{marginRight:"4px"}} class="fa-solid fa-trophy"></i> Add Achievements</Link>
                  </li>
                  <li className="nav-item">
